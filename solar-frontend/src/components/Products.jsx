...
const ICONS = { panel: <i class="bi bi-grid-3x3-gap-fill"></i>, inverter: <i class="bi bi-lightning-charge-fill"></i>, battery: <i class="bi bi-battery-full"></i>, structure: <i class="bi bi-diagram-3-fill"></i>, accessory: <i class="bi bi-grid-1x2-fill"></i>, cable: <i class="bi bi-plug-fill"></i> }
          ...
          {shown.map(p => (
            <div key={p.product_id} className={styles.card}>
              <div className={styles.imgBox}>
                <span>{ICONS[p.category] || <i class="bi bi-sun-fill"></i>}</span>
              </div>
